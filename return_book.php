...
<body class="bg-dark">
   ...
   <section>
       <div class="card-header">
        <br><br><br><br><br>
        <h2 style="text-align: center;"><strong>RETURNED BOOKS</strong></h2>
       </div>
       <div class="card-body">
        <table class="table table-bordered text-center" border="2">
            ...
            try {
                ...
                foreach ($returnedBooks as $book) {
                    ...
                    echo "<td><span class='btn btn-danger'><a href='deleteReturnedBooks.php?username=" . $book['name'] . "'>Delete</a></span></td>";
